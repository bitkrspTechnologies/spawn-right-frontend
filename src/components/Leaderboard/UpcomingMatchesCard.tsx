...
const UpcomingEventsSection = () => {
    return (
        <div className="font-[roboto] flex flex-col lg:flex-row gap-8 justify-center  items-start py-10 px-4">
            {/* Matches Section */}
            <div className="bg-[#141324] text-white rounded-2xl p-6 shadow-lg max-w-xl w-full min-h-[500px]">
                ...
                {upcomingMatches.map((match, index) => (
                    <div key={index} className="bg-[#1d1c3a] border border-gray-700 rounded-xl p-5 mb-2">
  ...
  <div className="w-1 h-100 bg-gradient-to-b from-transparent via-gray-400 to-transparent rounded-full mx-5" />
            ...
            <div className="bg-[#141324] text-white rounded-2xl p-5 shadow-lg max-w-xl w-full min-h-[500px]">
                ...
                {upcomingTournaments.map((tournament, index) => (
                    <div key={index} className="bg-[#1d1c3a] border border-gray-700 rounded-xl p-7 mb-2">
